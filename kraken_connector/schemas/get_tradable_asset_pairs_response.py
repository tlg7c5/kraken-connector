...
if TYPE_CHECKING:
    from ..schemas.get_tradable_asset_pairs_result import (
        GetTradableAssetPairsResult,
    )


@_attrs_define
class GetTradableAssetPairsResponse:
    """
    Example:
    ...
    Attributes:
        result (Union[Unset, GetTradableAssetPairsResult]): Pair names and their info
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "GetTradableAssetPairsResult"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        result: Union[Unset, GetTradableAssetPairsResult]
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = GetTradableAssetPairsResult.from_dict(_result)
