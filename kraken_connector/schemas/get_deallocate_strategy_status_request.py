...
if TYPE_CHECKING:
    from ..schemas.get_deallocate_strategy_status_request_nonce import (
        GetDeallocateStrategyStatusRequestNonce,
    )


@_attrs_define
class GetDeallocateStrategyStatusRequest:
    """
    Attributes:
        nonce (GetDeallocateStrategyStatusRequestNonce):
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        d = src_dict.copy()
        nonce = GetDeallocateStrategyStatusRequestNonce.from_dict(
