...
if TYPE_CHECKING:
    from ..schemas.batchadd_2_result import Batchadd2Result
...
class Batchadd2:
    """
    Attributes:
        result (Union[Unset, Batchadd2Result]):
        error (Union[Unset, List[List[str]]]):
    """

    result: Union[Unset, "Batchadd2Result"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        if isinstance(_result, Unset):
            ...
            result = Batchadd2Result.from_dict(_result)
