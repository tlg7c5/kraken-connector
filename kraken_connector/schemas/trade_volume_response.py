...
class TradeVolumeResponse:
    """
    Attributes:
        result (Union[Unset, TradeVolumeResult]): Trade TradeVolumeResponse
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "TradeVolumeResult"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        result: Union[Unset, TradeVolumeResult]
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = TradeVolumeResult.from_dict(_result)
