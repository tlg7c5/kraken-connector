...
if TYPE_CHECKING:
    from ..schemas.get_allocate_strategy_status_json_body_nonce import (
        GetAllocateStrategyStatusJsonBodyNonce,
    )


@_attrs_define
class GetAllocateStrategyStatusJsonBody:
    """
    Attributes:
        nonce (GetAllocateStrategyStatusJsonBodyNonce):
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        d = src_dict.copy()
        nonce = GetAllocateStrategyStatusJsonBodyNonce.from_dict(d.pop("nonce"))
