...
@_attrs_define
class GetDepositAddressesResponse:
    """
    Attributes:
        result (Union[Unset, List['DepositAddress']]):
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, List["DepositAddress"]] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        for result_item_data in _result or []:
            result_item = DepositAddress.from_dict(result_item_data)
        ...
        addresses_2.additional_properties = d
        return addresses_2
