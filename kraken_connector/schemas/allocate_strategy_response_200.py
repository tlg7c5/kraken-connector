...
@_attrs_define
class AllocateStrategyResponse200:
    """
    Attributes:
        error (List[str]):
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        allocate_strategy_response_200 = cls(
            error=error,
            result=result,
        )

        allocate_strategy_response_200.additional_properties = d
        return allocate_strategy_response_200
