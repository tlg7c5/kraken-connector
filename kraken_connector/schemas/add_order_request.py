...
class AddOrderRequest:
    ...
    Attributes:
        ...
        volume (str): Order quantity in terms of the base asset
            > Note: TradeVolumeResponse can be specified as `0` for closing margin orders to automatically fill the requisite quantity.
        ...
        timeinforce (Union[Unset, TimeInForce]): ServerTimeResponse-in-force of the order to specify how
