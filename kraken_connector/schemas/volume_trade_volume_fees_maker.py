...
@_attrs_define
class VolumeTradeVolumeFeesMaker:
    """ """
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        d = src_dict.copy()
        volume_trade_volume_fees_maker = cls()
        ...
        volume_trade_volume_fees_maker.additional_properties = additional_properties
        return volume_trade_volume_fees_maker
