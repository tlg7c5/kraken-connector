...
if TYPE_CHECKING:
    from ..schemas.info_2_result import Info2Result
...
class Info2:
    """
    Attributes:
        result (Union[Unset, Info2Result]):
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "Info2Result"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        result: Union[Unset, Info2Result]
        result = UNSET if isinstance(_result, Unset) else Info2Result.from_dict(_result)
