...
if TYPE_CHECKING:
    from ..schemas.withdrawal_2_result import Withdrawal2Result
...
class Withdrawal2:
    """
    Attributes:
        result (Union[Unset, Withdrawal2Result]):
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "Withdrawal2Result"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        if isinstance(_result, Unset):
            ...
            result = Withdrawal2Result.from_dict(_result)
