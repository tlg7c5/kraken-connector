...
class AllocationExitQueue:
    ...
    Attributes:
        ...
        allocations (List['AllocationExitQueueEntry']): Details
    ...
    allocations: List["AllocationExitQueueEntry"]
    converted: str
    native: str
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        for allocations_item_data in _allocations:
            allocations_item = AllocationExitQueueEntry.from_dict(allocations_item_data)
