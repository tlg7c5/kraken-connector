...
if TYPE_CHECKING:
    from ..schemas.get_trades_info_result import (
        GetTradesInfoResult,
    )


@_attrs_define
class GetTradesInfoResponse:
    """
    Example:
    ...
    Attributes:
        result (Union[Unset, GetTradesInfoResult]): Trade info
        error (Union[Unset, List[List[str]]]):
    """

    result: Union[Unset, "GetTradesInfoResult"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        result: Union[Unset, GetTradesInfoResult]
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = GetTradesInfoResult.from_dict(_result)
