...
class GetClosedOrdersResponse:
    """
    Attributes:
        result (Union[Unset, GetClosedOrdersResult]): Closed Orders
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "GetClosedOrdersResult"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        result: Union[Unset, GetClosedOrdersResult]
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = GetClosedOrdersResult.from_dict(_result)
