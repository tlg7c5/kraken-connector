...
if TYPE_CHECKING:
    from ..schemas.trades_result import TradesResult
...
class Trades:
    """
    Attributes:
        result (Union[Unset, TradesResult]):
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "TradesResult"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        if isinstance(_result, Unset):
            ...
            result = TradesResult.from_dict(_result)
