...
if TYPE_CHECKING:
    from ..schemas.list_allocations_response_200_result_items_item_amount_allocated_unbonding_allocations_item import (
        ListAllocationsResponse200ResultItemsItemAmountAllocatedUnbondingAllocationsItem,
    )


@_attrs_define
class ListAllocationsResponse200ResultItemsItemAmountAllocatedUnbonding:
    """Amount allocated in unbonding status

    Attributes:
        allocation_count (int): The total number of allocations in this state for this asset
        allocations (List['ListAllocationsResponse200ResultItemsItemAmountAllocatedUnbondingAllocationsItem']): Details
    ...
    def from_dict(cls: Self, src_dict: Dict[str, Any]) -> Self:
        ...
        for allocations_item_data in _allocations:
            allocations_item = ListAllocationsResponse200ResultItemsItemAmountAllocatedUnbondingAllocationsItem.from_dict(
