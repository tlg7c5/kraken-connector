...
if TYPE_CHECKING:
    from ..schemas.get_system_status_result import (
...
class GetSystemStatusResponse:
    """
    Attributes:
        result (Union[Unset, GetSystemStatusResult]):
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "GetSystemStatusResult"] = UNSET
    ...
    def from_dict(cls, src_dict: dict[str, Any]) -> Self:
        ...
        result: Unset | GetSystemStatusResult
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = GetSystemStatusResult.from_dict(_result)
