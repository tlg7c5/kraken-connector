...
class GetOrdersInfoResponse:
    """
    Attributes:
        result (Union[Unset, GetOrdersInfoResult]):
        error (Union[Unset, List[str]]):
    """

    result: Union[Unset, "GetOrdersInfoResult"] = UNSET
    ...
    def from_dict(cls: Self, src_dict: dict[str, Any]) -> Self:
        ...
        result: Unset | GetOrdersInfoResult
        if isinstance(_result, Unset):
            result = UNSET
        else:
            result = GetOrdersInfoResult.from_dict(_result)
        ...
        query_2.additional_properties = d
        return query_2
